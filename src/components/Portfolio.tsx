  ...
  const projects = [
    {
      ...
      description:
        "Sistema completo de gestão empresarial com módulos financeiro, vendas e estoque.",
      image: erpSystemImg,
    ...
    },
    {
      ...
      category: "Site",
      description:
        "Loja virtual moderna com catálogo dinâmico, carrinho e sistema de pagamento.",
      image: ecommerceImg,
    ...
    },
    {
      ...
      description:
        "Agente inteligente para atendimento ao cliente com processamento de linguagem natural.",
      image: chatbotImg,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {categories.map((category) => (
            <button
              key={category}
              className="px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 bg-white text-secondary-700 border border-secondary-300 hover:bg-primary-600 hover:text-white hover:border-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
            >
              {category}
            </button>
          ))}
        ...
        <div className="text-center mt-16">
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <p className="text-secondary-600 mb-6 max-w-2xl mx-auto">
              Entre em contato conosco e vamos desenvolver uma solução
