...
const Services = () => {
    ...
    const services = [
        {
            id: 'sistemas-web',
            title: 'Sistemas Web',
            description: 'Desenvolvemos sistemas web completos, desde ERPs empresariais até plataformas de e-commerce.',
            features: [
        ...
        },
        {
            ...
            description: 'Sites modernos, responsivos e otimizados para conversão e experiência do usuário.',
            features: [
                'Design responsivo',
                'SEO otimizado',
                'Carregamento rápido',
        ...
        },
        {
            ...
            description: 'Agentes inteligentes que automatizam processos complexos e melhoram a eficiência.',
            features: [
    ...
    return (
        <section id={`servicos-${servicesId}`} className="py-20 bg-white">
