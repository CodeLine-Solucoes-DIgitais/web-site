...
const About = () => {
    ...
    return (
        <section id={`sobre-${aboutId}`} className="py-20 bg-secondary-50">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-lg text-secondary-700 mb-6 leading-relaxed">
                            ...
                            com foco em sistemas web, desenvolvimento de sites e automações inteligentes
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <h3 className="font-semibold text-secondary-900">Qualidade</h3>
                            ...
                            <div className="flex items-center">
                                ...
                                <div>
                                    <h3 className="font-semibold text-secondary-900">Agilidade</h3>
                            ...
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-secondary-600">Atendimento especializado</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        <div className="bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl p-8 text-white">
                            <h3 className="text-2xl font-bold mb-6">Por que escolher a CodeLine?</h3>
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-primary-100">Anos de experiência em projetos complexos</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-primary-100">Utilizamos as mais modernas tecnologias</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-primary-100">Foco em ROI e métricas de sucesso</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-primary-100">Suporte ágil e personalizado</p>
                                    </div>
                                </div>
